document.addEventListener("DOMContentLoaded", function(event) { 
    ...
    svgTween.to('.t-mask', 1, { delay: 2, y: 140, opacity: 1, ease: "power3. out" })
        .to('.t-mask', 1, { delay: 1, y: 210, opacity: 1, ease: "power3. out" })
        .to('.e-mask', 1, { delay: 2, y: -10, opacity: 1, ease: "power3. out" })
        ...
        .to('.e2-mask', 1, { delay: 2, y: 50, opacity: 1, ease: "power3. out" })
